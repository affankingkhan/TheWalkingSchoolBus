...
public class ServerTestActivity extends AppCompatActivity {
    ...
    private void setupNewUserButton() {
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent createAccountIntent = CreateAccountActivity.makeCreateAccountActivityIntent(ServerTestActivity.this);
                startActivity(createAccountIntent);

//                // Build new user (with random email to avoid conflicts)
//                //User user = new User();
//                int random = (int) (Math.random() * 100000);
//                newUser.setEmail("testuser"+random+"@test.com");
//                newUser.setName("I. B. Rocking");
//                newUser.setPassword(userPassword);
//                newUser.setCurrentPoints(100);
//                newUser.setTotalPointsEarned(2500);
//                newUser.setRewards(new EarnedRewards());
//
//                // Make call
//                //This hands back a call object to the server
//                Call<User> caller = proxy.createUser(newUser);
//                //Call proxy here to pass in caller object
...
//                ProxyBuilder.callProxy(ServerTestActivity.this, caller, returnedUser -> response(returnedUser));
    ...
    private void setupLoginButton() {
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Log.i(TAG, newUser.getEmail() +" " + newUser.getPassword());

                // Register for token received:
                ProxyBuilder.setOnTokenReceiveCallback( token -> onReceiveToken(token));

                // Make call
                Call<Void> caller = proxy.login(newUser);
    ...
    private void onReceiveToken(String token) {
        ...
        //Log.w(TAG, "   --> NOW HAVE TOKEN: " + token + " " + newUser.getEmail() + " " + newUser.getPassword());
    ...
    public static Intent makeLaunchIntent(Context context) {
        return new Intent(context, ServerTestActivity.class);
    }
}
